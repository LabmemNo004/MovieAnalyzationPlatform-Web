<template>
  <div class="peopleinfo">
    ...
    <div class="person_info l">
      ...
      <div class="information">
        ...
        <div class="info1">
          ...
          <span class="span2"><el-link v-for="m in personInfo.movies" :key="m.movieID" @click="toMovieInfo(m.movieID)">{{
              m.movieName
            }} / </el-link></span>
        </div>
        <div class="info1">
    ...
    <div class="collect">
      ...
      <span v-bind:class="['span4',personInfo.is_collect?'color1':'color2']" @click="collect()"><i
...
export default {
  ...
  methods: {
    ...
    setPersonInfo(data) {
      ...
      this.personInfo.gender = data.gender === 1 ? "male" : "female";
      var dateType = "";
      var date = new Date();
